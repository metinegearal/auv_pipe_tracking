...
// --- Math Utilities ---
inline double normalize_angle_deg(double angle) { return std::fmod(angle + 180.0, 360.0) - 180.0; }
...
inline std::vector<double> world_to_auv_coordinates(
  const std::vector<double> & world_pos, double yaw)
{
