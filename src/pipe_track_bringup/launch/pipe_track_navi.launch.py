...
def generate_launch_description():
    ...
    config_file = os.path.join(bringup_dir, 'config', 'params_navi.yaml')
    holo_config_file = os.path.join(
        bringup_dir, 'config', 'holoocean_config.json')
    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[config_file, {
                'holoocean_config_path': holo_config_file}]
        ),
        Node(
