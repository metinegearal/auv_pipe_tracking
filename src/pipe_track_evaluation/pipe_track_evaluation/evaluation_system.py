...
class MetricsNode(Node):
    def __init__(self):
        ...
        # Subscriptions
        self.sub_gt = self.create_subscription(Odometry, 'holocean/odom', self.gt_cb, 10)
        # Assuming you publish your estimated position to another topic:
        self.sub_est = self.create_subscription(Odometry, 'auv/estimated_odom', self.est_cb, 10)
    ...
    def plot_trajectory(self):
        ...
        plt.legend()
        plt.savefig('/home/metin-ege/AIEngineering/RoboticFocus/HoloSystem/results/trajectory.png')
